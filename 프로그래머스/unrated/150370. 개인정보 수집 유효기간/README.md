...
### 놓친 점
1. 개인 정보 보관이 불가능한 첫 날을 구하는 것이 날짜 계산 자체는 더 깔끔
   * 지정된 보관 가능 달 수를 더해주고 12가 넘어가는 것에 대한 년도 계산 처리만 하면 됨
   * 개인 정보 보관이 가능한 마지막 날을 구하는 방식은 달 수 더하고 12 넘어가는 것에 대한 년도 처리 + 하루 빼기 했을 때 날짜 0이 되고 연쇠적인 달-년도 처리 등이 까다로움
2. 오늘 날짜와 개인 정보 보관 불가능 첫날 날짜를 통해 보관 가능 여부 판별 함수
   * 첫번째 거름망 : 보관년도<현재년도 : 불가능
     - 이 결과 (1)보관년도=현재년도과 (2)보관년도>현재년도 존재
     - (1)의 경우 month와 day에 대한 추가적 판별 필요
   * 두번째 거름망 : 보관년도=현재년도 and 보관달<현재달 : 불가능
     - 이 결과 (1) 보관년도=현재년도 and 보관달>현재달 (2) 보관년도=현재년도 and 보관달=현재달
     - (2)의 경우 day에 대한 추가적 판별 필요
   * 세번째 거름망: 보관년도=현재년도 and 보관달=현재달 and 보관날<=현재날 : 불가능
   * 이 세 거름망을 통과한 경우 아직까지 보관 가능한 데이터임
